...
<html lang="en">
  ...
  <head>
    ...
    <link href="../src/public/vendor/datatables/dataTables.bootstrap4.css" rel="stylesheet">

    <!-- Custom styles for this template-->
    <link href="../src/public/css/sb-admin.css" rel="stylesheet">
  ...
  <body id="page-top">
    ...
    <script src="../src/public/vendor/chart.js/Chart.min.js"></script>
    <script src="../src/public/vendor/datatables/jquery.dataTables.js"></script>
    <script src="../src/public/vendor/datatables/dataTables.bootstrap4.js"></script>

    <!-- Custom scripts for all pages-->
    <script src="../src/public/js/sb-admin.min.js"></script>

    <!-- Demo scripts for this page-->
    <script src="../src/public/js/demo/datatables-demo.js"></script>
    <script src="../src/public/js/demo/chart-area-demo.js"></script>
